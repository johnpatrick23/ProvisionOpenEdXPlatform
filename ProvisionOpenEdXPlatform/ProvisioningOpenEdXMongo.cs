            ...
            ILogger log)
        {
            ...
            else
            {
                try
                {
                    ...
                    INetworkSecurityGroup networkSecurityGroupmongo = _azureProd.NetworkSecurityGroups.Define($"{clusterName}1-mongo-nsg")
                            .WithRegion(region)
                    ...
                    INetworkInterface networkInterfacemongo = _azureProd.NetworkInterfaces.Define($"{clusterName}1-mongo-nic")
                        .WithRegion(region)
                        .WithExistingResourceGroup(resourceGroup)
                    ...
                    IVirtualMachine createVmmongo = _azureProd.VirtualMachines.Define($"{clusterName}1-mongo")
                        .WithRegion(region)
                        .WithExistingResourceGroup(resourceGroup)
